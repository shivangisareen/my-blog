    ...
    return (
        <Layout>
            ...
            <div className={links}>
                ...
                <a href="https://medium.com/@shivangisareen" target="_blank" rel="noreferrer">medium</a> {"\t"}
                <a href="https://shivangisareen.portfoliobox.net" target="_blank" rel="noreferrer">portfolio</a>
            </div>
        </Layout>
    );
};

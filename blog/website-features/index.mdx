...
I make use of the following syntax:
...
It's not mentioned in the GatsbyJS [tutorial](https://www.gatsbyjs.com/docs/tutorial/), but talked about
[here](https://www.gatsbyjs.com/docs/how-to/routing/customizing-components/).
...
instead of the default purple and code blocks (take a look at the one above) have been customized
...
The **BlogCard** itself was easy enough to implement using the [Card](https://mui.com/material-ui/react-card/) **MaterialUI** component; what
